'use strict';
const CACHE='laufapp-v0.2.0';
const staticUrls=()=>['./','styles.css','app.js','manifest.webmanifest','icon-192.png','assets/bugfix.css','assets/v020.css','assets/v020.js'].map(p=>new URL(p,self.registration.scope).toString());
