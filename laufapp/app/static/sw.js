'use strict';
const CACHE='laufapp-v0.2.3';
const staticUrls=()=>['./','styles.css?v=0.2.3','app.js?v=0.2.3','manifest.webmanifest?v=0.2.3','icon-192.png?v=0.2.3','assets/bugfix.css?v=0.2.3','assets/v020.css?v=0.2.3','assets/v020.js?v=0.2.3','assets/v020_science.css?v=0.2.3','assets/v020_science.js?v=0.2.3','assets/v023_aggressiveness.js?v=0.2.3'].map(p=>new URL(p,self.registration.scope).toString());
