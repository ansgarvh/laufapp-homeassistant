'use strict';
const CACHE='laufapp-v0.2.23';
const staticUrls=()=>['./','styles.css?v=0.2.5','app.js?v=0.2.23','manifest.webmanifest?v=0.2.21','icon.svg?v=0.2.21','icon-192.png?v=0.2.21','apple-touch-icon.png?v=0.2.21','assets/bugfix.css?v=0.2.5','assets/v020.css?v=0.2.18','assets/v020.js?v=0.2.18','assets/v020_science.css?v=0.2.5','assets/v020_science.js?v=0.2.5','assets/v023_aggressiveness.js?v=0.2.5','assets/v025.css?v=0.2.5','assets/v025.js?v=0.2.5','assets/v0213.css?v=0.2.13','assets/v0213.js?v=0.2.13','assets/v0215.css?v=0.2.15','assets/v0217.css?v=0.2.17','assets/v0220.css?v=0.2.20','assets/v0222.css?v=0.2.22','assets/v0223.css?v=0.2.23'].map(p=>new URL(p,self.registration.scope).toString());
