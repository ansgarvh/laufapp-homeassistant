'use strict';
const CACHE='laufapp-v0.2.19';
const staticUrls=()=>['./','styles.css?v=0.2.5','app.js?v=0.2.19','manifest.webmanifest?v=0.2.5','icon-192.png?v=0.2.5','assets/bugfix.css?v=0.2.5','assets/v020.css?v=0.2.18','assets/v020.js?v=0.2.18','assets/v020_science.css?v=0.2.5','assets/v020_science.js?v=0.2.5','assets/v023_aggressiveness.js?v=0.2.5','assets/v025.css?v=0.2.5','assets/v025.js?v=0.2.5','assets/v0213.css?v=0.2.13','assets/v0213.js?v=0.2.13','assets/v0215.css?v=0.2.15','assets/v0217.css?v=0.2.17'].map(p=>new URL(p,self.registration.scope).toString());
