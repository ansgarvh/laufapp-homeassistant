...
const staticUrls=()=>['./','styles.css?v=0.2.2','app.js?v=0.2.2','manifest.webmanifest?v=0.2.2','icon-192.png?v=0.2.2','bugfix.css?v=0.2.2','assets/v020.css?v=0.2.2','assets/v020.js?v=0.2.2','assets/v020_science.css?v=0.2.2','assets/v020_science.js?v=0.2.2','assets/v022_settings.js?v=0.2.2'].map(p=>new URL(p,self.registration.scope).toString());
